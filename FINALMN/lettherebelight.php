...
$sql="SELECT m.Mov_id, m.Mov_Title, m.Mov_Year, m.Mov_Lang, m.Mov_Desp, r.Rev_Stars, a.Act_Name,c.Role,d.Dir_Name FROM movies m, rating r,cast c,actor a, director d WHERE m.Mov_id=r.Mov_id and a.Act_id=c.Act_id and d.Dir_id=m.Dir_id and m.Mov_id=307";
...
<body>
    ...
    <div class="grid_12">
      <div class="slider_wrapper">
        <div id="camera_wrap">
          <div data-src="images/letthere.jpg"> </div>
          <div data-src="images/letthere2.jpg"> </div>
          <div data-src="images/letthere1.jpg"> </div>
        </div>
      </div>      
      </div>
      </div> 
...
while ($s=mysql_fetch_assoc($records)) {
	...
	echo "<br>";
		echo "<br>";
	?><center>
<span class="imdbRatingPlugin" data-user="ur69108916" data-title="tt5804314" data-style="p2"><a href="http://www.imdb.com/title/tt5804314/?ref_=plg_rt_1"><img src="http://g-ecx.images-amazon.com/images/G/01/imdb/plugins/rating/images/imdb_38x18.png" alt=" Let There Be Light
(2017) on IMDb" />
